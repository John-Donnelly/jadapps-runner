...
export const BUILTIN_TOOLS: Record<string, { module: string; npmDeps: string[] }> = {
  ...
  // Audio family — 41 connectors, all shell out to ffmpeg/ffprobe.
  "mp3-to-wav": { module: "mp3-to-wav", npmDeps: [] },
  "wav-to-mp3": { module: "wav-to-mp3", npmDeps: [] },
  "mp3-to-flac": { module: "mp3-to-flac", npmDeps: [] },
  "flac-to-mp3": { module: "flac-to-mp3", npmDeps: [] },
  "m4a-to-mp3": { module: "m4a-to-mp3", npmDeps: [] },
  "ogg-to-mp3": { module: "ogg-to-mp3", npmDeps: [] },
  "opus-to-mp3": { module: "opus-to-mp3", npmDeps: [] },
  "wav-to-flac": { module: "wav-to-flac", npmDeps: [] },
  "video-to-mp3": { module: "video-to-mp3", npmDeps: [] },
  "video-to-wav": { module: "video-to-wav", npmDeps: [] },
  "audio-trimmer": { module: "audio-trimmer", npmDeps: [] },
  "audio-merger": { module: "audio-merger", npmDeps: [] },
  "audio-splitter": { module: "audio-splitter", npmDeps: [] },
  "audio-reverser": { module: "audio-reverser", npmDeps: [] },
  "fade-in-out": { module: "fade-in-out", npmDeps: [] },
  "pitch-shifter": { module: "pitch-shifter", npmDeps: [] },
  "time-stretcher": { module: "time-stretcher", npmDeps: [] },
  "tempo-changer": { module: "tempo-changer", npmDeps: [] },
  "bitrate-changer": { module: "bitrate-changer", npmDeps: [] },
  "sample-rate-converter": { module: "sample-rate-converter", npmDeps: [] },
  "mono-to-stereo": { module: "mono-to-stereo", npmDeps: [] },
  "channel-splitter": { module: "channel-splitter", npmDeps: [] },
  "audio-compressor": { module: "audio-compressor", npmDeps: [] },
  "volume-normalizer": { module: "volume-normalizer", npmDeps: [] },
  "discord-fit": { module: "discord-fit", npmDeps: [] },
  "whatsapp-fit": { module: "whatsapp-fit", npmDeps: [] },
  "true-peak-limiter": { module: "true-peak-limiter", npmDeps: [] },
  "loudness-normalizer": { module: "loudness-normalizer", npmDeps: [] },
  "ai-noise-reducer": { module: "ai-noise-reducer", npmDeps: [] },
  "silence-stripper": { module: "silence-stripper", npmDeps: [] },
  "speech-leveler": { module: "speech-leveler", npmDeps: [] },
  "de-esser": { module: "de-esser", npmDeps: [] },
  "voice-eq": { module: "voice-eq", npmDeps: [] },
  "spectrum-analyzer": { module: "spectrum-analyzer", npmDeps: [] },
  "waveform-generator": { module: "waveform-generator", npmDeps: [] },
  "album-art-extractor": { module: "album-art-extractor", npmDeps: [] },
  "id3-editor": { module: "id3-editor", npmDeps: [] },
  "bpm-finder": { module: "bpm-finder", npmDeps: [] },
  ...
  // SVG family — 30 connectors, mostly XML manipulation.
  "svg-metadata-scrubber": { module: "svg-metadata-scrubber", npmDeps: [] },
  "svg-hex-swapper": { module: "svg-hex-swapper", npmDeps: [] },
  "svg-to-base64": { module: "svg-to-base64", npmDeps: [] },
  "svg-rtl-mirror": { module: "svg-rtl-mirror", npmDeps: [] },
  "svg-responsive-wrapper": { module: "svg-responsive-wrapper", npmDeps: [] },
  "svg-monochrome-converter": { module: "svg-monochrome-converter", npmDeps: [] },
  "svg-precision-tuner": { module: "svg-precision-tuner", npmDeps: [] },
  "svg-pro-minifier": { module: "svg-pro-minifier", npmDeps: [] },
  "svg-unused-defs-purger": { module: "svg-unused-defs-purger", npmDeps: [] },
  "svg-viewbox-fixer": { module: "svg-viewbox-fixer", npmDeps: [] },
  "svg-css-data-uri": { module: "svg-css-data-uri", npmDeps: [] },
  "svg-clip-path-gen": { module: "svg-clip-path-gen", npmDeps: [] },
  "svg-filter-injector": { module: "svg-filter-injector", npmDeps: [] },
  "svg-css-variable-injector": { module: "svg-css-variable-injector", npmDeps: [] },
  "svg-blob-generator": { module: "svg-blob-generator", npmDeps: [] },
  "svg-pattern-tiler": { module: "svg-pattern-tiler", npmDeps: [] },
  "svg-polygon-gen": { module: "svg-polygon-gen", npmDeps: [] },
  "svg-wave-divider": { module: "svg-wave-divider", npmDeps: [] },
  "svg-stroke-to-fill": { module: "svg-stroke-to-fill", npmDeps: [] },
  "svg-canvas-exporter": { module: "svg-canvas-exporter", npmDeps: ["sharp"] },
  "svg-path-simplifier": { module: "svg-path-simplifier", npmDeps: [] },
  "svg-compression-estimator": { module: "svg-compression-estimator", npmDeps: [] },
  "svg-app-icon-gen": { module: "svg-app-icon-gen", npmDeps: ["sharp"] },
  "svg-favicon-master": { module: "svg-favicon-master", npmDeps: ["sharp"] },
  "svg-sprite-builder": { module: "svg-sprite-builder", npmDeps: [] },
  "svg-to-jsx": { module: "svg-to-jsx", npmDeps: [] },
  "svg-to-tailwind": { module: "svg-to-tailwind", npmDeps: [] },
  "svg-to-vue-svelte": { module: "svg-to-vue-svelte", npmDeps: [] },
  "svg-font-to-path": { module: "svg-font-to-path", npmDeps: ["@pdf-lib/fontkit"] },
  "svg-qr-code": { module: "svg-qr-code", npmDeps: [] },
  // Archive family — 40 connectors. ZIP via jszip; native pure-JS where possible,
  // driver_missing for AES-encrypted ZIP / 7z / RAR which need a 7z binary.
  "folder-to-zip": { module: "folder-to-zip", npmDeps: ["jszip"] },
  "archive-previewer": { module: "archive-previewer", npmDeps: ["jszip"] },
  "file-listing-generator": { module: "file-listing-generator", npmDeps: ["jszip"] },
  "archive-size-analyzer": { module: "archive-size-analyzer", npmDeps: ["jszip"] },
  "file-type-breakdown": { module: "file-type-breakdown", npmDeps: ["jszip"] },
  "archive-metadata-extractor": { module: "archive-metadata-extractor", npmDeps: ["jszip"] },
  "selective-extractor": { module: "selective-extractor", npmDeps: ["jszip"] },
  "multi-format-extractor": { module: "multi-format-extractor", npmDeps: ["jszip"] },
  "nested-archive-extractor": { module: "nested-archive-extractor", npmDeps: ["jszip"] },
  "batch-extraction-manager": { module: "batch-extraction-manager", npmDeps: ["jszip"] },
  "comment-extractor": { module: "comment-extractor", npmDeps: ["jszip"] },
  "archive-merger": { module: "archive-merger", npmDeps: ["jszip"] },
  "selective-zipper": { module: "selective-zipper", npmDeps: ["jszip"] },
  "encrypted-archive-detector": { module: "encrypted-archive-detector", npmDeps: [] },
  "gzip-to-zip": { module: "gzip-to-zip", npmDeps: ["jszip"] },
  "zip-to-tar-gz": { module: "zip-to-tar-gz", npmDeps: ["jszip"] },
  "tar-gz-to-zip": { module: "tar-gz-to-zip", npmDeps: ["jszip"] },
  "zip-to-7z": { module: "zip-to-7z", npmDeps: [] },
  "archive-format-converter": { module: "archive-format-converter", npmDeps: ["jszip"] },
  "archive-splitter": { module: "archive-splitter", npmDeps: ["jszip"] },
  "archive-diff": { module: "archive-diff", npmDeps: ["jszip"] },
  "archive-integrity-tester": { module: "archive-integrity-tester", npmDeps: ["jszip"] },
  "archive-password-tester": { module: "archive-password-tester", npmDeps: [] },
  "archive-signing-info": { module: "archive-signing-info", npmDeps: ["jszip"] },
  "auto-format-detector": { module: "auto-format-detector", npmDeps: [] },
  "batch-compression-report": { module: "batch-compression-report", npmDeps: ["jszip"] },
  "checksum-generator": { module: "checksum-generator", npmDeps: [] },
  "compression-level-optimizer": { module: "compression-level-optimizer", npmDeps: ["jszip"] },
  "compression-ratio-calculator": { module: "compression-ratio-calculator", npmDeps: ["jszip"] },
  "corrupted-zip-repair": { module: "corrupted-zip-repair", npmDeps: ["jszip"] },
  "empty-folder-pruner": { module: "empty-folder-pruner", npmDeps: ["jszip"] },
  "encrypted-zip-creator": { module: "encrypted-zip-creator", npmDeps: [] },
  "filename-sanitizer": { module: "filename-sanitizer", npmDeps: ["jszip"] },
  "multi-part-archive-creator": { module: "multi-part-archive-creator", npmDeps: ["jszip"] },
  "path-prefix-remover": { module: "path-prefix-remover", npmDeps: ["jszip"] },
  "redundancy-analyzer": { module: "redundancy-analyzer", npmDeps: ["jszip"] },
  "smart-archive-compressor": { module: "smart-archive-compressor", npmDeps: ["jszip"] },
  "streaming-zip-builder": { module: "streaming-zip-builder", npmDeps: ["jszip"] },
  "timestamp-normalizer": { module: "timestamp-normalizer", npmDeps: ["jszip"] },
  "zip-comment-editor": { module: "zip-comment-editor", npmDeps: ["jszip"] },
  // Font family — 40 connectors. Mix of pure-text (CSS/HTML emit), fontkit-based
  // metadata extractors, manual SFNT directory rewrites, and driver_missing
  // shims for tools that need fontTools/harfbuzz.
  "clamp-font-size-generator": { module: "clamp-font-size-generator", npmDeps: [] },
  "css-variable-generator-font": { module: "css-variable-generator-font", npmDeps: [] },
  "dark-mode-font-adjuster": { module: "dark-mode-font-adjuster", npmDeps: [] },
  "font-display-strategy": { module: "font-display-strategy", npmDeps: [] },
  "font-face-generator": { module: "font-face-generator", npmDeps: [] },
  "google-fonts-css-generator": { module: "google-fonts-css-generator", npmDeps: [] },
  "preload-tag-builder": { module: "preload-tag-builder", npmDeps: [] },
  "system-font-stack-generator": { module: "system-font-stack-generator", npmDeps: [] },
  "typography-scale-builder": { module: "typography-scale-builder", npmDeps: [] },
  "weight-presets-builder": { module: "weight-presets-builder", npmDeps: [] },
  "weight-progression-viewer": { module: "weight-progression-viewer", npmDeps: [] },
  "variable-font-size-calc": { module: "variable-font-size-calc", npmDeps: [] },
  "font-to-base64": { module: "font-to-base64", npmDeps: [] },
  "font-format-identifier": { module: "font-format-identifier", npmDeps: [] },
  "font-fingerprinter": { module: "font-fingerprinter", npmDeps: ["@pdf-lib/fontkit"] },
  "font-metadata-extractor": { module: "font-metadata-extractor", npmDeps: ["@pdf-lib/fontkit"] },
  "font-metrics-analyzer": { module: "font-metrics-analyzer", npmDeps: ["@pdf-lib/fontkit"] },
  "glyph-count-analyzer": { module: "glyph-count-analyzer", npmDeps: ["@pdf-lib/fontkit"] },
  "glyph-inspector": { module: "glyph-inspector", npmDeps: ["@pdf-lib/fontkit"] },
  "character-coverage-map": { module: "character-coverage-map", npmDeps: ["@pdf-lib/fontkit"] },
  "character-whitelist-builder": { module: "character-whitelist-builder", npmDeps: [] },
  "font-subsetter": { module: "font-subsetter", npmDeps: [] },
  "latin-filter": { module: "latin-filter", npmDeps: [] },
  "unicode-point-assigner": { module: "unicode-point-assigner", npmDeps: [] },
  "opentype-features-inspector": { module: "opentype-features-inspector", npmDeps: ["@pdf-lib/fontkit"] },
  "ttf-to-woff": { module: "ttf-to-woff", npmDeps: [] },
  "ttf-to-woff2": { module: "ttf-to-woff2", npmDeps: ["wawoff2"] },
  "woff2-to-ttf": { module: "woff2-to-ttf", npmDeps: ["wawoff2"] },
  "axis-range-optimizer": { module: "axis-range-optimizer", npmDeps: ["@pdf-lib/fontkit"] },
  "variable-font-axis-mapper": { module: "variable-font-axis-mapper", npmDeps: ["@pdf-lib/fontkit"] },
  "variable-font-freezer": { module: "variable-font-freezer", npmDeps: [] },
  "hinting-stripper": { module: "hinting-stripper", npmDeps: [] },
  "colour-table-remover": { module: "colour-table-remover", npmDeps: [] },
  "name-table-cleaner": { module: "name-table-cleaner", npmDeps: [] },
  "emoji-remover": { module: "emoji-remover", npmDeps: [] },
  "font-comparison-overlay": { module: "font-comparison-overlay", npmDeps: [] },
  "font-to-svg-font": { module: "font-to-svg-font", npmDeps: ["@pdf-lib/fontkit"] },
  "icon-font-previewer": { module: "icon-font-previewer", npmDeps: ["@pdf-lib/fontkit"] },
  "kerning-pair-auditor": { module: "kerning-pair-auditor", npmDeps: ["@pdf-lib/fontkit"] },
  "ligature-toggler": { module: "ligature-toggler", npmDeps: [] },
};
